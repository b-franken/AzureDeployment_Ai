...
class LightweightIntentClassifier:
    ...
    def __init__(self) -> None:
        ...
        self.resource_patterns = {
            "storage": [r"\bstorage\b", r"\bblob\b", r"\bs3\b", r"\bbucket\b"],
            "webapp": [r"\bweb\s*app\b", r"\bapp\s*service\b", r"\bwebsite\b", r"\bapi\b"],
            "vm": [
                r"\bvm\b",
            ...
            "database": [r"\bdatabase\b", r"\bdb\b", r"\bsql\b", r"\bmysql\b", r"\bpostgres\b"],
            "network": [r"\bnetwork\b", r"\bvnet\b", r"\bvpc\b", r"\bsubnet\b"],
            "kubernetes": [r"\baks\b", r"\bkubernetes\b", r"\bk8s\b", r"\bcluster\b"],
            "resource_group": [r"\bresource\s*group\b", r"\brg\b"],
        }
    ...
    def _is_provision_intent(self, text: str) -> bool:
        ...
        has_provision_keyword = any(keyword in text_lower for keyword in self.provision_keywords)
...
def replace_embeddings_classifier_in_dev() -> bool:
    ...
    use_lightweight = os.getenv("USE_LIGHTWEIGHT_CLASSIFIER", "true").lower() in {
        "1",
        "true",
        "yes",
    }
