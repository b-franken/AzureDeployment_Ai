...
@dataclass
class NLUPatterns:
    location_patterns: list[tuple[str, str]] = field(
    ...
    resource_patterns: dict[str, list[str]] = field(
        default_factory=lambda: {
            "resource_group": [
    ...
    in_context_patterns: list[str] = field(
        default_factory=lambda: [
    ...
    compliance_patterns: dict[str, str] = field(
        default_factory=lambda: {
