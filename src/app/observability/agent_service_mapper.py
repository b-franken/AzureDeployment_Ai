...
class AgentServiceMapper:
    ...
    def get_service_name(cls, agent_class_name: str) -> str:
        return cls._service_mappings.get(agent_class_name, f"agent-{agent_class_name.lower()}")
    ...
    def with_agent_context(
        cls, agent_class_name: str, operation: str, attributes: dict[str, Any] | None = None
        ...
        with tracer.start_as_current_span(
            f"{agent_class_name}.{operation}", attributes=span_attributes
        ) as span:
            yield span
