...
class UserMemoryService:
    ...
    def __init__(self):
        self._store: Optional[AsyncMemoryStore] = None
        ...
        with tracer.start_as_current_span("memory.get_user_stats") as span:
            ...
            try:
                ...
                stats = {
                    ...
                    "memory_utilization_percent": min(100, (message_count / store.max_total_memory) * 100),
                ...
                logger.info(
                    "User memory statistics generated",
                    extra={"user_id": user_id, **stats}
                )
