...
class EmbeddingsConfig:
    ...
    batch_wait_ms: int = int(os.getenv("EMB_BATCH_WAIT_MS", "50"))  # Wait up to 50ms to collect more texts for batching
    enable_dynamic_batching: bool = os.getenv("EMB_ENABLE_DYNAMIC_BATCHING", "true").lower() in {"1", "true", "yes"}
    ...
    use_local_for_classification: bool = os.getenv("USE_LOCAL_EMBEDDINGS_FOR_CLASSIFICATION", "true").lower() in {"1", "true", "yes"}
