...
async def initialize_vector_for_docker() -> dict[str, Any]:
    try:
        ...
        logger.info(
            "Vector system initialized for Docker", initialization_results=initialization_results
        )
        ...
        return {"success": False, "error": str(e), "plugin_manager": None}


_docker_plugin_manager: PluginManager | None = None


async def get_docker_plugin_manager() -> PluginManager | None:
