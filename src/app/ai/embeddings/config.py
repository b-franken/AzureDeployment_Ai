...
class EmbeddingsConfig:
    enable: bool = os.getenv("ENABLE_CLASSIFIER", "0").lower() in {
        "1", "true", "yes"}
    ...
    batch_size: int = int(os.getenv("EMB_BATCH_SIZE", "128"))
    max_concurrency: int = int(os.getenv("EMB_MAX_CONCURRENCY", "3"))
    ttl_seconds: int = int(os.getenv("EMB_CACHE_TTL_SECONDS", "3600"))
    batch_wait_ms: int = int(os.getenv("EMB_BATCH_WAIT_MS", "50"))
